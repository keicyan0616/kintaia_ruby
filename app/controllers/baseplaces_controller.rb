class BaseplacesController < ApplicationController
  ...
  def destroy
    ...
    Baseplace.find(params[:id]).destroy
  ...
  def update
    ...
    @kyoten1 = Baseplace.find(params[:id])
  ...
  def touroku
    ...
    kyoten_data = Baseplace.new(kyoten_name: @kyoten_name, kyoten_shurui: @kyoten_shurui)
    kyoten_data.save
...
private
  ...
  def baseplace_params
    params.require(:baseplace).permit(:kyoten_name, :kyoten_shurui)
  end
end